...
<p align="center">
  <a href="https://github.com/nblths/departic/actions/workflows/ci.yml"><img src="https://github.com/nblths/departic/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
  <a href="https://github.com/nblths/departic/actions/workflows/release.yml"><img src="https://github.com/nblths/departic/actions/workflows/release.yml/badge.svg" alt="Release"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-green" alt="License"></a>
  <a href="https://github.com/nblths/departic/releases"><img src="https://img.shields.io/github/v/release/nblths/departic" alt="Release"></a>
</p>
...
```bash
docker pull ghcr.io/nblths/departic:latest
```

### 2. Create the configuration

```bash
curl -O https://raw.githubusercontent.com/nblths/departic/main/departic.example.yaml
...
services:
  departic:
    image: ghcr.io/nblths/departic:latest
...
```bash
# Clone
git clone https://github.com/nblths/departic.git
cd departic
